    ...
    orders.map((order) => {
      ...
      return {
        ...
        items: order.items.map((item) => ({
          ...
          supplierUrl: item.productVariant.supplierUrl ?? item.productVariant.product.supplierUrl ?? null,
          supplierName: item.productVariant.supplierName ?? item.productVariant.product.supplierName ?? null,
          supplierSku: item.productVariant.supplierSku ?? item.productVariant.product.supplierSku ?? null,
