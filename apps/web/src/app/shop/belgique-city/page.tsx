...
type CityCollection = {
  slug: 'bepremium' | 'beheritage' | 'beardennes';
  label: string;
  subtitle: string;
  accent: string;
};
...
const COLLECTIONS: CityCollection[] = [
  {
    ...
    subtitle: 'Brussels, Antwerp, Ghent, Bruges, Leuven and more.',
    accent: 'from-[#111111] via-[#E63946] to-[#FFD166]',
  },
  {
    slug: 'beheritage',
    label: 'Heritage Cities',
    subtitle: 'Ypres, Tournai, Dinant, Spa, Hasselt and more.',
    accent: 'from-[#1D3557] via-[#6C757D] to-[#F4A259]',
  },
  {
    slug: 'beardennes',
    label: 'Ardennes & Coast',
    subtitle: 'Ostend, Durbuy, Bastogne, Bouillon, Stavelot and more.',
    accent: 'from-[#0B132B] via-[#1C2541] to-[#5BC0BE]',
  },
];
...
const PHOTO_SLICES = [
  {
    title: 'Brussels',
    query: 'Brussels Belgium Grand Place city',
    position: 'center top',
  },
  {
    title: 'Antwerp',
    query: 'Antwerp Belgium cathedral city',
    position: 'center 35%',
  },
  {
    title: 'Ghent',
    query: 'Ghent Belgium canal city',
    position: 'center 50%',
  },
  {
    title: 'Bruges',
    query: 'Bruges Belgium old town city',
...
export default function BelgiqueCityPage() {
  ...
  return (
    <main className="min-h-screen bg-[#090909] px-6 py-20 text-white md:px-16">
      <section className="mx-auto max-w-6xl">
        <div className="rounded-3xl border border-white/15 bg-[#0F0F10] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#FFD166]">Dope&Cute Studio</p>
          <h1 className="mt-3 text-4xl font-black md:text-5xl">Belgique City Collection</h1>
          <p className="mt-3 max-w-3xl text-sm text-white/70 md:text-base">
            Casquettes inspirees des villes belges. Broderie du nom de ville,
