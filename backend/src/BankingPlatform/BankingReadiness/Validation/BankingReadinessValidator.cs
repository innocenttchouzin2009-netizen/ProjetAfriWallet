...
public sealed class BankingReadinessValidator
{
    public ReadinessValidationSummary Run()
    {
        var summary = new ReadinessValidationSummary();
    ...
    private static void Pass(ReadinessValidationSummary summary, string name)
    {
